    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">{{ __('Product Scrapp List') }}
                <div class="row">
                    <div class="col-md-8">
                        <form class="form-inline" action="{{route('audio_video')}}" method="get">
                            ...
                            <div class="form-group">
                                ...
                                &nbsp;&nbsp;<a class="btn btn-warning" href="{{route('audio_video')}}">Reset</a>
                            </div>
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($scrap->fotocentreindia_link)
                                    <strong style="white-space: nowrap">₹ {{number_format(@$scrap->price_details->fotocentreindia_price,2)}}</strong>
                                    <p><a href="{{$scrap->fotocentreindia_link}}" target="__blank">Link</a></p>
                                    @endif
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label>Fotocentreindia Link </label>
                                                        <input type="url" name="fotocentreindia_link" value="{{$scrap->fotocentreindia_link}}" class="form-control" >
                                                    </div>
                                                </div>
                                                <div class="col-md-9">
                                                    <div class="form-group">
                        ...
                        <form class="form" id="add_ward_form" method="post" action="{{route('scrapp.store')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Fotocentreindia Link </label>
                                        <input type="url" name="fotocentreindia_link" class="form-control" >
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="form-group">
